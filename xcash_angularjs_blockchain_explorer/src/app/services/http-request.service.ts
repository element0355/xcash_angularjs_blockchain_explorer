...
SERVER_HOSTNAME_AND_PORT_SEND_HEXADECIMAL_TRANSACTION:string = "https://explorer.x-delegate.io/sendhexadecimaltransaction";
SERVER_HOSTNAME_AND_PORT_GET_CURRENT_BLOCK_HEIGHT:string = "https://explorer.x-delegate.io/getcurrentblockheight";
SERVER_HOSTNAME_AND_PORT_GET_BLOCKCHAIN_DATA:string = "https://explorer.x-delegate.io/getblockchaindata";
SERVER_HOSTNAME_AND_PORT_GET_NODES_LIST:string = "https://explorer.x-delegate.io/getnodeslist";
SERVER_HOSTNAME_AND_PORT_GET_GENERATED_SUPPLY:string = "https://explorer.x-delegate.io/getgeneratedsupply";
SERVER_HOSTNAME_AND_PORT_GET_CIRCULATING_SUPPLY:string = "https://explorer.x-delegate.io/getcirculatingsupply";
SERVER_HOSTNAME_AND_PORT_GET_LAST_BLOCK_DATA:string = "https://explorer.x-delegate.io/getlastblockdata";
SERVER_HOSTNAME_AND_PORT_GET_BLOCK_DATA:string = "https://explorer.x-delegate.io/getblockdata";
SERVER_HOSTNAME_AND_PORT_GET_TX_POOL_DATA:string = "https://explorer.x-delegate.io/gettransactionpooldata";
SERVER_HOSTNAME_AND_PORT_GET_BLOCKCHAIN_DATA_SETTINGS:string = "https://explorer.x-delegate.io/getblockchaindatasettings";
SERVER_HOSTNAME_AND_PORT_GET_BLOCK_TRANSACTION_DATA:string = "https://explorer.x-delegate.io/getblocktransactiondata";
SERVER_HOSTNAME_AND_PORT_GET_TRANSACTION_DATA:string = "https://explorer.x-delegate.io/gettransactiondata";
SERVER_HOSTNAME_AND_PORT_VERIFY_RESERVE_PROOF:string = "https://explorer.x-delegate.io/verifyreserveproofapi";
SERVER_HOSTNAME_AND_PORT_VERIFY_PREMINE_FUNDS_AIRDROP:string = "https://explorer.x-delegate.io/verifypreminefundsairdrop";
SERVER_HOSTNAME_AND_PORT_VERIFY_PREMINE_FUNDS_XCASH:string = "https://explorer.x-delegate.io/verifypreminefundsxcash";
SERVER_HOSTNAME_AND_PORT_VERIFY_PREMINE_FUNDS_XCASH_REWARDS:string = "https://explorer.x-delegate.io/verifypreminefundsxcashrewards";
SERVER_HOSTNAME_AND_PORT_VERIFY_PREMINE_FUNDS_XCASH_INVESTORS:string = "https://explorer.x-delegate.io/verifypreminefundsxcashinvestors";
SERVER_HOSTNAME_AND_PORT_GET_TRANSACTION_CONFIRMATIONS:string = "https://explorer.x-delegate.io/gettransactionconfirmations";
SERVER_HOSTNAME_AND_PORT_CREATE_INTEGRATED_ADDRESS:string = "https://explorer.x-delegate.io/createintegratedaddressapi";
SERVER_HOSTNAME_AND_PORT_GET_LAST_BLOCKS_TRANSACTION_DATA:string = "https://explorer.x-delegate.io/getlastblockstransactiondata";
SERVER_HOSTNAME_AND_PORT_GET_TRANSACTION_DATA_SEARCH_RESULTS:string = "https://explorer.x-delegate.io/gettransactiondatasearchresults";
SERVER_HOSTNAME_AND_PORT_GET_CHART_DATA:string = "https://explorer.x-delegate.io/getchartdata";
SERVER_HOSTNAME_AND_PORT_GET_MARKET_DATA:string = "https://explorer.x-delegate.io/getmarketdata";
SERVER_HOSTNAME_AND_PORT_GET_HISTORICAL_MARKET_DATA:string = "https://explorer.x-delegate.io/gethistoricalmarketdata";
