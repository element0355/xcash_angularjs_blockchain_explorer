...
SERVER_HOSTNAME_AND_PORT_SEND_HEXADECIMAL_TRANSACTION:string = "https://explorer.xcash.network/sendhexadecimaltransaction";
SERVER_HOSTNAME_AND_PORT_GET_CURRENT_BLOCK_HEIGHT:string = "https://explorer.xcash.network/getcurrentblockheight";
SERVER_HOSTNAME_AND_PORT_GET_BLOCKCHAIN_DATA:string = "https://explorer.xcash.network/getblockchaindata";
SERVER_HOSTNAME_AND_PORT_GET_NODES_LIST:string = "https://explorer.xcash.network/getnodeslist";
SERVER_HOSTNAME_AND_PORT_GET_GENERATED_SUPPLY:string = "https://explorer.xcash.network/getgeneratedsupply";
SERVER_HOSTNAME_AND_PORT_GET_CIRCULATING_SUPPLY:string = "https://explorer.xcash.network/getcirculatingsupply";
SERVER_HOSTNAME_AND_PORT_GET_LAST_BLOCK_DATA:string = "https://explorer.xcash.network/getlastblockdata";
SERVER_HOSTNAME_AND_PORT_GET_BLOCK_DATA:string = "https://explorer.xcash.network/getblockdata";
SERVER_HOSTNAME_AND_PORT_GET_TX_POOL_DATA:string = "https://explorer.xcash.network/gettransactionpooldata";
SERVER_HOSTNAME_AND_PORT_GET_BLOCKCHAIN_DATA_SETTINGS:string = "https://explorer.xcash.network/getblockchaindatasettings";
SERVER_HOSTNAME_AND_PORT_GET_BLOCK_TRANSACTION_DATA:string = "https://explorer.xcash.network/getblocktransactiondata";
SERVER_HOSTNAME_AND_PORT_GET_TRANSACTION_DATA:string = "https://explorer.xcash.network/gettransactiondata";
SERVER_HOSTNAME_AND_PORT_VERIFY_RESERVE_PROOF:string = "https://explorer.xcash.network/verifyreserveproofapi";
SERVER_HOSTNAME_AND_PORT_VERIFY_PREMINE_FUNDS_AIRDROP:string = "https://explorer.xcash.network/verifypreminefundsairdrop";
SERVER_HOSTNAME_AND_PORT_VERIFY_PREMINE_FUNDS_XCASH:string = "https://explorer.xcash.network/verifypreminefundsxcash";
SERVER_HOSTNAME_AND_PORT_VERIFY_PREMINE_FUNDS_XCASH_REWARDS:string = "https://explorer.xcash.network/verifypreminefundsxcashrewards";
SERVER_HOSTNAME_AND_PORT_VERIFY_PREMINE_FUNDS_XCASH_INVESTORS:string = "https://explorer.xcash.network/verifypreminefundsxcashinvestors";
SERVER_HOSTNAME_AND_PORT_GET_TRANSACTION_CONFIRMATIONS:string = "https://explorer.xcash.network/gettransactionconfirmations";
SERVER_HOSTNAME_AND_PORT_CREATE_INTEGRATED_ADDRESS:string = "https://explorer.xcash.network/createintegratedaddressapi";
SERVER_HOSTNAME_AND_PORT_GET_LAST_BLOCKS_TRANSACTION_DATA:string = "https://explorer.xcash.network/getlastblockstransactiondata";
SERVER_HOSTNAME_AND_PORT_GET_TRANSACTION_DATA_SEARCH_RESULTS:string = "https://explorer.xcash.network/gettransactiondatasearchresults";
SERVER_HOSTNAME_AND_PORT_GET_CHART_DATA:string = "https://explorer.xcash.network/getchartdata";
SERVER_HOSTNAME_AND_PORT_GET_MARKET_DATA:string = "https://explorer.xcash.network/getmarketdata";
SERVER_HOSTNAME_AND_PORT_GET_HISTORICAL_MARKET_DATA:string = "https://explorer.xcash.network/gethistoricalmarketdata";
